import pytest
from tictactoe import tictactoe_helpers
...
class TestGetters:
    ...
    def test_get_col(self, tictactoe_board):
        ...
        assert tictactoe_helpers.get_col(tictactoe_board, [2, 1]) == [-1, -1, -1]
        assert tictactoe_helpers.get_col(tictactoe_board, [1, 2]) == [1, 0, 1]

    def test_get_diag(self, tictactoe_board):
        assert tictactoe_helpers.get_diag(tictactoe_board, [0, 0]) == [1, -1, 1]
        ...
        assert tictactoe_helpers.get_diag(tictactoe_board, [1, 1]) == [1, -1, 1]

    def test_get_antidiag(self, tictactoe_board):
        assert tictactoe_helpers.get_antidiag(tictactoe_board, [0, 0]) == [1]
        assert tictactoe_helpers.get_antidiag(tictactoe_board, [1, 0]) == [-1, -1]
        assert tictactoe_helpers.get_antidiag(tictactoe_board, [2, 1]) == [-1, 0]
        assert tictactoe_helpers.get_antidiag(tictactoe_board, [1, 2]) == [-1, 0]
        assert tictactoe_helpers.get_antidiag(tictactoe_board, [1, 1]) == [0, -1, 1]
