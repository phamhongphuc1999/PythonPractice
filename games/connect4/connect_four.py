...
class ConnectFour(BaseGame):
    ...
    def encode_lists(self, field_lists: Matrix) -> int:
        """
    ...
    def decode_binary(self, state_int: int) -> Matrix:
        """
    ...
    def convert_mcts_state_to_nn_state(self, mcts_state: int) -> Matrix:
        """[summary]
    ...
    def _check_won(self, field: Matrix, col: int, delta_row: int) -> bool:
        """
