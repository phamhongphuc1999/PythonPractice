...
from utils import game_provider
from utils.game_play_utils import TBMeanTracker, play_game
from model import Net, NetWrapper
...
if __name__ == "__main__":
    ...
    with TBMeanTracker(writer, batch_size=10) as tb_tracker:
        ...
        while True:
            ...
            train_neural_net(game, replay_buffer, optimizer, tb_tracker, device)
